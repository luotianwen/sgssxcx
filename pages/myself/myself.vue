<template>
	<view>
		<div id="happyiIndex">
			<header class="happyiIndex-header">
				<div class="header-bg" style="background-image: url(http://test2.img.hongkzh.com/userfiles/1/user/2018/11/IMG_20181121_151803.jpg), url();"></div>
