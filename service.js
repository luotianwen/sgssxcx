// const httpUrl = "http://192.168.2.124:8081/v1/";
...
const agentWithdrawal=function(){
	return httpUrl+"shop/agentWithdrawal";
}
const agentOrderHisList=function(){
	return httpUrl+"shop/agentOrderHisList";
}
